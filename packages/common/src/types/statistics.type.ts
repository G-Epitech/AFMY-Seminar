export type Statistics = {
  customers: {
    ...
    history: [{ date: Date; count: number }]; // Number of customers by date in the time frame
    history_previous: [{ date: Date; count: number }]; // Number of customers by date in the previous time frame
  ...
  events: {
    ...
    history: [{ date: Date; count: number }]; // Number of events by date in the time frame
  };
